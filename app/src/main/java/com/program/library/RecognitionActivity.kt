...
import com.program.library.databinding.ActivityRecognitionBinding
...
class RecognitionActivity : AppCompatActivity() {
    private lateinit var binding: ActivityRecognitionBinding // Referencia para el binding de la vista
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // title appBar
        supportActionBar?.title = "Screen Text"

        // MlKit
        binding = ActivityRecognitionBinding.inflate(layoutInflater) // Infla el layout con ViewBinding
    ...
    private fun launchShare() {
        ...
        // intent untuk pencarian di Google
        val intent = Intent(Intent.ACTION_VIEW).apply {
            data = Uri.parse("https://www.google.com/search?q=$textToShare")
        }
